...
public class BaseRestRouteBuilder extends EndpointRouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        onException(BadRequestException.class)
                ...
                .logHandled(true)
                .logStackTrace(true)
                .transform(exceptionMessage().append('&').append(400))
                .setHeader(Exchange.HTTP_RESPONSE_CODE, constant(400))
                .transform(datasonnetEx("resource:classpath:custom-exception-message.ds", String.class)
        ...
        onException(ResourceNotFoundException.class)
                ...
                .logHandled(true)
                .logStackTrace(true)
                .transform(exceptionMessage().append('&').append(404))
